...
from app.academic_agent.tool_executor import _tool_get_teaching_recommendations  # noqa: E402
...
async def check_instructor_scope(course_id: int):
    async with AsyncSessionLocal() as session:
        ...
        return context, owner_result, other_result, instructor_kb, student_kb
...
def main() -> int:
    ...
    context, owner_result, other_result, instructor_kb, student_kb = asyncio.run(check_instructor_scope(course["id"]))
    checks = {
